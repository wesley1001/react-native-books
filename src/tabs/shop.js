...
class Recommend extends Component {
    ...
    _onPress(item) {
        AsyncStorage.setItem('current', JSON.stringify(item), e => {
            this.props && this.props.navigator && this.props.navigator.push({
                title: item.name,
                component: Details
            });
        });
    ...
    render() {
        ...
        return (
            <View style={{flex:1,backgroundColor:'#EEE'}}>
                ...
                <Header items={Common.defaultProps.header}
                        onPress={e=>this.setState({'head':[Recommend,Categorye,Ranking][e]})}/>
